    ...
    <div class="line bouncein">
        <div class="xs6 xm4 xs3-move xm4-move">
            ...
            <div class="panel loginbox">
                <div class="text-center margin-big padding-big-top"><h1>进存销管理系统</h1></div>
                ...
                <div style="padding:10px;"><input type="submit" class="button bg-main text-big input-big" value="登录" style="width:48%">&nbsp;<a href="zhuceuser.jsp"><input type="button" class="button bg-main text-big input-big" value="注册" style="width:48%"></a></div>
