	 ...
	 pagination="true" url="../getBumens" fit="true" toolbar="#tb">
		<thead>
			<tr>
				...
				<th field="bumenName" width="50">部门名称</th>
				<th field="bumenMark" width="100">部门描述</th>
				<th field="bumenMark1" width="100">部门备注</th>
				<th field="bumenMark2" width="50" formatter="formatType">部门类型</th>
			</tr>
		</thead>
	</table>
		...
		<form id="fm" method="post">
			<table>
				...
				<tr>
					...
					<td>性别：</td>
					<td><select class="easyui-combobox" id="bumenMark2" name="bumenMark2" editable="false" panelHeight="auto" style="width: 155px">
