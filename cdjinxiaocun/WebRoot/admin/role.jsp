	 ...
	 pagination="true" url="../getRoles" fit="true" toolbar="#tb">
		<thead>
			<tr>
				...
				<th field="roleName" width="50">权限名称</th>
				<th field="roleMark" width="100">权限描述</th>
			</tr>
		</thead>
	</table>
	...
	<div id="dlg" class="easyui-dialog" style="width: 500px;height: 180px;padding: 10px 20px"
		...
		<form id="fm" method="post">
			<table>
				...
				<tr>
					<td>备注：</td>
					<td><input type="text" name="roleMark1" id="roleMark1" class="easyui-validatebox" required="true"/></td>
					<td>性别：</td>
					<td><select class="easyui-combobox" id="roleMark2" name="roleMark2" editable="false" panelHeight="auto" style="width: 155px">
