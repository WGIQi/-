...
<!--startprint-->
	 ...
	 pagination="true" url="../getUsers" fit="true" toolbar="#tb">
		<thead>
			<tr>
				...
				<th field="roleId" width="20" hidden="true">权限ID</th>
				<th field="roleName" width="40">权限</th>
				<th field="userDate1" width="40" formatter="datetostr">时间</th>
			</tr>
		</thead>
	</table>
	...
	<div id="tb">
		...
		&nbsp;权限：&nbsp;<input class="easyui-combobox" id="s_roleId" name="s_roleId"  data-options="panelHeight:'auto',editable:false,valueField:'roleId',textField:'roleName',url:'../roleComboList'"/>
