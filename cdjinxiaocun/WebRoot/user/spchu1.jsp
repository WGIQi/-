...
var userId = <%=userId%>;
	...
	function openSpchuModifyDialog(){
		...
		$("#dlg").dialog("open").dialog("setTitle","编辑退货信息");
	...
	function daoruSpchus(){
		$("#daoru").dialog("open").dialog("setTitle","导入退货信息");
		daoruurl="../daoruSpchu";
	}
	...
	function shangchuanSpchu(){
		...
		var row=selectedRows[0];
		$("#shangchuan").dialog("open").dialog("setTitle","上传退货信息");
...
<!--startprint-->
	<table id="dg" title="退货信息" class="easyui-datagrid" fitColumns="true"
	...
	<div id="tb">
		...
		<div>
		&nbsp;客户：&nbsp;<input type="text" name="s_spchuName" id="s_spchuName" size="10"/>
