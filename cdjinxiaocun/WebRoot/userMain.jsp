...
<div class="leftnav">
  ...
  <ul style="display:block">
    <li><a href="user/gonggao.jsp" target="right"><span class="icon-caret-right"></span>公告管理</a></li>
  </ul>
  ...
  <ul>
    <li><a href="user/spgys.jsp" target="right"><span class="icon-caret-right"></span>供应商管理</a></li>
    <li><a href="user/sptype.jsp" target="right"><span class="icon-caret-right"></span>商品类型</a></li>
  </ul>
  <h2><span class="icon-user"></span>商品信息</h2>
  <ul>
    <li><a href="user/shangpin.jsp" target="right"><span class="icon-caret-right"></span>商品信息</a></li>
    <li><a href="user/shangpinyujing.jsp" target="right"><span class="icon-caret-right"></span>商品预警</a></li>
  </ul>
  <h2><span class="icon-user"></span>采购信息</h2>
  <ul>
    <li><a href="user/spjin.jsp" target="right"><span class="icon-caret-right"></span>采购信息</a></li>
  </ul>
  <h2><span class="icon-user"></span>销售信息</h2>
  <ul>
    <li><a href="user/spchu0.jsp" target="right"><span class="icon-caret-right"></span>销售信息</a></li>
    <li><a href="user/spchu1.jsp" target="right"><span class="icon-caret-right"></span>退货信息</a></li>
  </ul>
</div>
