...
<body>
				...
				<div class="span6">
					<div class="widget-box">
						...
						<div class="widget-content nopadding">
							<form name="form1" action="zhuceUser" method="post"
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" class="span11" placeholder="邮箱"
											name="userMark1" id="userMark1" />
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">班级:</label>
									<div class="controls">
										<input class="easyui-combobox" id="xxbanId" name="xxbanId" size="10" data-options="panelHeight:'auto',editable:false,valueField:'xxbanId',textField:'xxbanName',url:'xxbanComboList'"/>
									</div>
								</div>
	...
	<script type="text/javascript">
		function check() {
			...
			var userMark1 = document.form1.userMark1.value;
			...
			if (!regemail.test(userMark1)) {
				alert('请输入有效的邮箱地址 ！');
				document.form1.userMark1.focus();
				return false;
			}
		}
	</script>
